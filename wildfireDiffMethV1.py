...
if ret:
    # Remove comment if you want image to show (i think)
    #cv2.imshow("Captured Image", frame3)
    cv2.imwrite("cam3.png", frame3)
else:
    print("cam3 failed")

# Read the saved images in grayscale. Let us say img1 & img 3 are the left and right, and img2 is the peak. 
img1 = cv2.imread("cam1.png",cv2.IMREAD_GRAYSCALE)
img2 = cv2.imread("cam2.png",cv2.IMREAD_GRAYSCALE)
img3 = cv2.imread("cam3.png",cv2.IMREAD_GRAYSCALE)
